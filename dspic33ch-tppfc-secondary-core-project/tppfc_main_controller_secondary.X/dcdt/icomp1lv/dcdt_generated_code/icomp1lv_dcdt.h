...
/**
  ...
  ----    -----     ----------    ---      ---
  a1      0.778     0.506         16582    0x40C6
  a2      0.222     0.144         4732     0x127C
  b0      1.537     1.000         32764    0x7FFC
  b1      0.019     0.012         409      0x0199
  b2      -1.518    -0.987        -32355   0x819D
...
#define ICOMP1LV_COMP_2P2Z_COEFF_A1      0x40C6
#define ICOMP1LV_COMP_2P2Z_COEFF_A2      0x127C
#define ICOMP1LV_COMP_2P2Z_COEFF_B0      0x7FFC
#define ICOMP1LV_COMP_2P2Z_COEFF_B1      0x0199
#define ICOMP1LV_COMP_2P2Z_COEFF_B2      0x819D
#define ICOMP1LV_COMP_2P2Z_POSTSCALER    0x6262
#define ICOMP1LV_COMP_2P2Z_POSTSHIFT     0xFFFF
#define ICOMP1LV_COMP_2P2Z_PRESHIFT      0x0000


// Compensator Clamp Limits
#define ICOMP1LV_COMP_2P2Z_MIN_CLAMP    0x0000
#define ICOMP1LV_COMP_2P2Z_MAX_CLAMP    0x4B00
